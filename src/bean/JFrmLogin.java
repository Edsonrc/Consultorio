...
public class JFrmLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setForeground(new java.awt.Color(119, 137, 106));
        ...
        jLabel2.setForeground(new java.awt.Color(119, 137, 106));
        jLabel2.setText("Usuário");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(119, 137, 106));
        ...
        setSize(new java.awt.Dimension(388, 200));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(list1.size() == 1){
            ...
            JOptionPane.showMessageDialog(null,"Desculpe, mas os dados estão invalidos. Tente novamente.", "Erro", JOptionPane.ERROR_MESSAGE);
        }
